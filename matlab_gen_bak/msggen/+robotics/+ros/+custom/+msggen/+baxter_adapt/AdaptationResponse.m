classdef AdaptationResponse < robotics.ros.Message
    %AdaptationResponse MATLAB implementation of baxter_adapt/AdaptationResponse
    ...
    properties (Constant)
        MessageType = 'baxter_adapt/AdaptationResponse' % The ROS message type
    end
    ...
    methods
        function obj = AdaptationResponse(msg)
            %AdaptationResponse Construct the message object AdaptationResponse
        ...
        function set.Response(obj, response)
            ...
            validateattributes(response, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'AdaptationResponse', 'response');
        ...
        function set.Filename(obj, filename)
            ...
            validateattributes(filename, {'char'}, {}, 'AdaptationResponse', 'filename');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.baxter_adapt.AdaptationResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.baxter_adapt.AdaptationResponse;
            obj.reload(strObj);
        end
    end
end

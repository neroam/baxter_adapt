classdef ImitationResponse < robotics.ros.Message
    %ImitationResponse MATLAB implementation of baxter_adapt/ImitationResponse
    ...
    properties (Constant)
        MessageType = 'baxter_adapt/ImitationResponse' % The ROS message type
    end
    ...
    methods
        function obj = ImitationResponse(msg)
            %ImitationResponse Construct the message object ImitationResponse
        ...
        function set.Response(obj, response)
            ...
            validateattributes(response, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'ImitationResponse', 'response');
        ...
        function set.Filename(obj, filename)
            ...
            validateattributes(filename, {'char'}, {}, 'ImitationResponse', 'filename');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.baxter_adapt.ImitationResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.baxter_adapt.ImitationResponse;
            obj.reload(strObj);
        end
    end
end
